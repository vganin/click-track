...
actual class PrimitiveAudioPlayer(
    ...
    actual suspend fun play(
        ...
        try {
            ...
            var currentPlayerNodeBufferInSeconds = 0
            ...
            for (samplesChunk in samplesChunks) {
                audioPlayerNode.scheduleBuffer(
                    ...
                    completionHandler = {
                        currentPlayerNodeBufferInSeconds -= BUFFER_LENGTH_IN_SECONDS
                        progress = (progress + BUFFER_LENGTH_IN_SECONDS.seconds) % singleIterationDuration
                        reportProgress(progress)
                    },
                )
                ...
                while (currentPlayerNodeBufferInSeconds >= PLAYER_NODE_MAX_BUFFER_LENGTH_IN_SECONDS) {
    ...
    private fun FloatArray.toAVAudioPCMBuffer(): AVAudioPCMBuffer {
        ...
        buffer.frameLength = size.toUInt()
        return buffer
    }
