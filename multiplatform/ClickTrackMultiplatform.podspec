Pod::Spec.new do |spec|
    spec.name                     = 'ClickTrackMultiplatform'
    spec.version                  = '1.0'
    spec.homepage                 = 'https://www.vsevolodganin.com/'
    spec.source                   = { :http=> ''}
    spec.authors                  = ''
    spec.license                  = ''
    spec.summary                  = 'Shared multiplatform code'
    spec.vendored_frameworks      = 'build/cocoapods/framework/ClickTrackMultiplatform.framework'
    spec.libraries                = 'c++'
    spec.ios.deployment_target    = '15.0'
    spec.dependency 'FirebaseCrashlytics', '12.8.0'
    ...
    spec.script_phases = [
        {
            :name => 'Build ClickTrackMultiplatform',
